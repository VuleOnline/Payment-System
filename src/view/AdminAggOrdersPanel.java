...
private static Map<String, AdminAggOrdersPanel> cache = new HashMap<>();
 public static AdminAggOrdersPanel getAdminAggOrdersPanel(String sessionId) 
    {
	 if(!cache.containsKey(sessionId)) 
		{
		 AdminAggOrdersPanel adminAggOrderListPanel  = new AdminAggOrdersPanel();
			cache.put(sessionId, adminAggOrderListPanel);
		}
 ...
 public void initialize() {
     ...
     dateTxt = new JFormattedTextField(maskForm);
		...
		String[] columns = {"S.No", "Commision", "Total", "Rec Money", "Change", "Reversed", "Emp ID", "Date"};
