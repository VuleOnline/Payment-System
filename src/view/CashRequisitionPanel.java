...
public class CashRequisitionPanel extends JPanel implements TxtFieldListener{
...
public CashRequisitionPanel() {
	...
	public static CashRequisitionPanel getCashRequisitionPanel(String sessionId) 
	{
		...
		{
			CashRequisitionPanel cashReqPanel = new CashRequisitionPanel();
			cache.put(sessionId, cashReqPanel);
		}
